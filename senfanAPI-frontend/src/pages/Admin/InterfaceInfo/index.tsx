...
} from '@/services/senfanAPI-backend/interfaceInfoController';
...
const TableList: React.FC = () => {
  ...
  const handleOnline = async (record: API.IdRequest) => {
    ...
    try {
      ...
      hide();
      message.error('发布失败，' + error.mesaage);
      return false;
    }
  };
  /**
  ...
  const handleOffline = async (record: API.IdRequest) => {
    ...
    try {
      ...
      hide();
      message.error('下线失败，' + error.mesaage);
      return false;
    }
  };
  /**
  ...
  const handleRemove = async (record: API.InterfaceInfo) => {
    ...
    try {
      ...
      hide();
      message.error('删除失败，' + error.mesaage);
      return false;
    }
  };
  /**
